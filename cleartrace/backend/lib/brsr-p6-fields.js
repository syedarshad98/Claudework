...
module.exports = [
  {
    ...
    fields: [
      ...
      { key: 'energy_intensity_per_rupee_current',  label: 'Energy Intensity (GJ/₹ cr) — Current FY',  type: 'number', precision: 8, unit: 'GJ/₹cr', calculated: true },
      { key: 'energy_intensity_per_rupee_previous', label: 'Energy Intensity (GJ/₹ cr) — Previous FY', type: 'number', precision: 8, unit: 'GJ/₹cr', calculated: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'water_intensity_per_rupee_current',  label: 'Water Intensity (kL/₹ cr) — Current FY',  type: 'number', precision: 8, unit: 'kL/₹cr', calculated: true },
      { key: 'water_intensity_per_rupee_previous', label: 'Water Intensity (kL/₹ cr) — Previous FY', type: 'number', precision: 8, unit: 'kL/₹cr', calculated: true },
  ...
  },
  {
    ...
    field_ref: 'p6.ghg',
    fields: [
      { key: 'scope1_current',                   label: 'Scope 1 — Current FY (tCO₂e)',            type: 'number', precision: 2, unit: 'tCO₂e' },
      { key: 'scope1_previous',                  label: 'Scope 1 — Previous FY (tCO₂e)',           type: 'number', precision: 2, unit: 'tCO₂e' },
      { key: 'scope2_current',                   label: 'Scope 2 — Current FY (tCO₂e)',            type: 'number', precision: 2, unit: 'tCO₂e' },
      { key: 'scope2_previous',                  label: 'Scope 2 — Previous FY (tCO₂e)',           type: 'number', precision: 2, unit: 'tCO₂e' },
      { key: 'ghg_intensity_per_rupee_current',  label: 'GHG Intensity (tCO₂e/₹ cr) — Current FY',  type: 'number', precision: 10, unit: 'tCO₂e/₹cr', calculated: true },
      { key: 'ghg_intensity_per_rupee_previous', label: 'GHG Intensity (tCO₂e/₹ cr) — Previous FY', type: 'number', precision: 10, unit: 'tCO₂e/₹cr', calculated: true },
  ...
  },
  {
    ...
    leadership: true,
    fields: [
      { key: 'scope3_current',                      label: 'Scope 3 — Current FY (tCO₂e)',               type: 'number', precision: 2,  unit: 'tCO₂e' },
      { key: 'scope3_previous',                     label: 'Scope 3 — Previous FY (tCO₂e)',              type: 'number', precision: 2,  unit: 'tCO₂e' },
      { key: 'scope3_intensity_per_rupee_current',  label: 'Scope 3 Intensity (tCO₂e/₹ cr) — Current FY',  type: 'number', precision: 10, unit: 'tCO₂e/₹cr', calculated: true },
      { key: 'scope3_intensity_per_rupee_previous', label: 'Scope 3 Intensity (tCO₂e/₹ cr) — Previous FY', type: 'number', precision: 10, unit: 'tCO₂e/₹cr', calculated: true },
    ],
  },
];
