...
module.exports = [
  {
    ...
    fields: [
      ...
      { key: 'paid_up_capital_inr',     label: 'Paid-up Capital (₹)',              type: 'currency' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'turnover_inr',   label: 'Turnover (₹)',             type: 'currency' },
      { key: 'net_worth_inr',  label: 'Net Worth (₹)',            type: 'currency' },
      {
